...
\footnotesize
UAV Structure from Motion (SfM) data for
...
\begin{column}{0.3\textwidth}
 ...
 \begin{itemize}
  \item points $\rightarrow$ binning $\rightarrow$ raster $\rightarrow$ analysis
  \item points $\longrightarrow$ decimation $\longrightarrow$ vector
  \begin{itemize}
    \item analysis
    \item interpolation $\rightarrow$ raster $\rightarrow$ analysis
  \end{itemize}
\end{itemize}
...
%   \includegraphics[height=0.5\textheight]%
    {grass/range_on_ground_from_north}
...
\begin{column}{0.45\textwidth}
 ...
 \begin{itemize}
  ...
  \begin{itemize}
  \item reads multiple tiles as one
    \begin{itemize}
...
\begin{itemize}
  ...
  \item 64bit version
  \item Brunswick county: $\approx$1050 files, $>9$ billion points, $\approx$0.5 hour % method=n, 2.5GB (40 thousand x 40 thousand cells, 5 ft res, >1.5 bil cells)
  \item Hyde county: $\approx$950 files, $>4$ billion points, base elevation 5ft raster, 60ft height, $\approx$3 hours % 2.4 billion cells in base rast, about half water
