...
\textcolor{gray}{
\footnotesize
Brunswick county: binning, $\approx$1050 files, $>9$ billion points, $\approx$0.5 hour % method=n, 2.5GB (40 thousand x 40 thousand cells, 5 ft res, >1.5 bil cells)
\\
Hyde county: binning, $\approx$950 files, $>4$ billion points, base elevation 5ft raster, 60ft height, $\approx$3 hours % 2.4 billion cells in base rast, about half water
}
