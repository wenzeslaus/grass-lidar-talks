...
\begin{itemize}
  ...
  \end{itemize}
  % TODO: 2.1 mil bodov mi v.surf.rst.mp zrata za 11 min.,
\end{itemize}
...
% grass vectors
% v.external PDAL, PDAL C API (future)
% v.in.pdal (now)
...
\begin{center}
  \includegraphics[width=\textwidth]{tangible/elevation_and_histogram}
\end{center}
