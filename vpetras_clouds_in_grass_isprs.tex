...
\makebox[\imgsize][c]{\captionfont keep all}%
~%
\makebox[\imgsize][c]{\captionfont skip every 5}%
~%
\makebox[\imgsize][c]{\captionfont keep every 20}%
~%
\makebox[\imgsize][c]{\captionfont keep every 100}%
